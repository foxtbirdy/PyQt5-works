...
class MainWindow(QMainWindow):
    ...
    def the_button_was_released(self):
        ...
        if self.button_is_checked == True:
            self.setWindowTitle("The Yokio")
            self.button.setText("Yokio says that you clicked this button")
        else:
            self.setWindowTitle("The Kaiju")
            self.button.setText("KAIJU says you clicked this button")
